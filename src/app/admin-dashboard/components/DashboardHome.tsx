  ...
  const summaryCards = [
    {
      ...
      status: "total",
      color: "bg-purple-200 border-purple-400 text-purple-900 hover:bg-purple-300",
      icon: "📊"
    },
    {
      title: t("pending"),
        ...
        {summaryCards.map((card, index) => (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm font-medium opacity-75">{t("View Details")}</span>
            </div>
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    {complaint.building} - {complaint.room} • {complaint.category} • {complaint.status}
                  </p>
                ...
                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getCategoryColor(complaint.category)}`}>
                  {complaint.status}
                </span>
              </div>
            ))}
