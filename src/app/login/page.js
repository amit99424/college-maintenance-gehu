...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (normalizedCaptchaInput !== normalizedCaptcha) {
        setCaptchaError(t("wrongCaptcha"));
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      {/* Main Container */}
      <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 lg:px-8 py-2 sm:py-4">
        <div className="w-[90%] sm:w-full max-w-md bg-white/20 backdrop-transparent-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden animate-fadeInZoom">
          {/* Logo Area */}
          ...
          >
            ...
            <div className="relative w-full">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full py-2.5 sm:py-3 px-3 text-sm sm:text-base rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-400 focus:shadow-lg focus:shadow-green-400/50 bg-white/90 text-gray-900 shadow-md transition-all duration-300"
                />
                {captchaError && (
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-2.5 sm:py-3 text-sm sm:text-base rounded-lg text-white font-semibold transition-colors ${
                isLoading
      ...
      >
        <DialogContent className="p-4 sm:p-6 rounded-lg shadow-lg bg-white/90 text-gray-900 max-w-[95vw] sm:max-w-sm mx-auto mt-10 sm:mt-20 relative">
          <div className="text-center">
            <h3 className="text-lg font-semibold mb-4">{t("enterMaintenanceKey")}</h3>
            <input
              type="password"
              placeholder={t("enterMaintenanceKey")}
            ...
            <div className="flex justify-end gap-2 flex-wrap sm:flex-nowrap">
              ...
              <button
                ...
                className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-green-600 text-white rounded hover:bg-blue-700 w-full sm:mt-0"
              >
                {t("submit")}
              </button>
            </div>
